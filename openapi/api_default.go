...
type DefaultAPI interface {
	...
	*/
	LocaltxsubmissionTxPost(ctx context.Context) DefaultAPILocaltxsubmissionTxPostRequest

	// LocaltxsubmissionTxPostExecute executes the request
	//  @return string
	LocaltxsubmissionTxPostExecute(r DefaultAPILocaltxsubmissionTxPostRequest) (string, *http.Response, error)
}
...
func (a *DefaultAPIService) LocaltxsubmissionTxPostExecute(r DefaultAPILocaltxsubmissionTxPostRequest) (string, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.LocaltxsubmissionTxPost")
	if err != nil {
