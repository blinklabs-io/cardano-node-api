...
type LocalstatequeryAPI interface {
	...
	*/
	...
	/*
		...
		Search UTxOs by asset. The address parameter is required when API_MAX_UTXO_SEARCH_RESULTS is unset or <= 0.
...
// Asset name (hex), empty string for unnamed assets
...
// Optional: Filter by address. The address parameter is required when API_MAX_UTXO_SEARCH_RESULTS is unset or &lt;&#x3D; 0.
