...
func main() {
	...
	assetName := "assetName_example" // string | Asset name (hex), empty string for unnamed assets
	address := "address_example" // string | Optional: Filter by address. The address parameter is required when API_MAX_UTXO_SEARCH_RESULTS is unset or <= 0. (optional)
 ...
 **assetName** | **string** | Asset name (hex), empty string for unnamed assets | 
 **address** | **string** | Optional: Filter by address. The address parameter is required when API_MAX_UTXO_SEARCH_RESULTS is unset or &lt;&#x3D; 0. |
